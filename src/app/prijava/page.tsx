...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Greska pri Google prijavljivanju');
    } finally {
      setLoading(false);
    }
  };
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link href="/zaboravljena-lozinka" className="text-xs text-primary hover:underline">
